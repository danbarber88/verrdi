  ...
  <Layout>
    ...
    <Container>
      <Content>
        <h1>Driver</h1>
        <p>
          If you are an Agency, Ltd Co. Driver, or an owner operator responsible
          for organising your CPC Training we have a number of courses planned
          throughout 2019 - 2020 to offer you flexible, convenient & comfortable
          locations. Whether you plan to do one session at a time or an
          intensive course we offer various discounts for loyal customers.
        </p>
        <p>
        ...
        <p>
          ...
          industry is no longer worth it to them we need you to stay and pass on
          all that knowledge & know how. Please talk to us to discuss how we at
          Verrdi would like to thank you and show our appreciation for your time
          spent in serving the Haulage Industry.
        </p>
        <h3>List of Driver CPC Courses Available (all Courses are 7 Hours) </h3>
        <ul>
        ...
        <p>
          Remember you can sit the same course as many times as you wish but why
          would you? The courses will be rotated through and all dates posted
          for each one. So if you are in no rush to complete your CPC and are
          undertaking periodic training at least one course per year then book a
