...
const ContactPage = ({ data }) => {
    ...
    return (
        <Layout>
            ...
            >
                <p>
                    Get in touch for any reason. We can answer any and all of
                    your <span className="yellow-text">questions</span>.
                </p>
            </Banner>
            <Container>
                <Content>
                    ...
                    <h2>Payment info</h2>
                    <p>
                        If you are interested in booking a course we are happy
                        for you to contact us direct and we can arrange payment
                        over the telephone, good old fashioned cash on the day
                        (small deposit required) or to book online head over to
                        our booking page.
                    </p>
