  ...
  return (
    <Layout>
      ...
      <Container>
        <Content>
          <h3>
            This website, www.verrdi.co.uk (the "Website"), is operated by Verdi
            TSS.
          </h3>
          <h3>What are cookies?</h3>
          <p>
            Cookies are a small text files that are stored in your web browser
            that allows Verdi TSS or a third party to recognize you. Cookies can
            be used to collect, store and share bits of information about your
            activities across websites, including on Verdi TSS website.
          </p>
          ...
          <p>
            A persistent cookie will remain on your devices for a set period of
            time specified in the cookie. We use these cookies where we need to
            identify you over a longer period of time. For example, we would use
            a persistent cookie if you asked that we keep you signed in.
          </p>
          ...
          <p>
            ...
            how to do this, visit the help pages of your browser.
          </p>
          <p>
